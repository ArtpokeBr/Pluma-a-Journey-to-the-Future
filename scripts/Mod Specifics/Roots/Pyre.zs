...
Pyre.addRecipe(
  ...
  [<railcraft:bloodstained:2>, <contenttweaker:taintedsoildust>, <quark:soul_powder>, <biomesoplenty:ash>, <ore:slimeballBlood>] // a list of five ingredients (no more, no less)
);
