...
Pyre.addRecipe(
  ...
  [<railcraft:bloodstained:2>, <contenttweaker:taintedsoildust>, <quark:soul_powder>, <contenttweaker:fiery_baykoks_essence>, <ore:slimeballBlood>] // a list of five ingredients (no more, no less)
);
