...
recipes.addShaped(<mbd:time_manipulator:0> * 1, [[<ore:stoneAncient>, <ore:lightPlateAluminium>, <ore:stoneAncient>], [<ore:circuitMv>, <contenttweaker:vanadiumsteel_casing:0>, <ore:circuitMv>],[<ore:stoneAncient>, <ore:lightPlateAluminium>, <ore:stoneAncient>]]);
